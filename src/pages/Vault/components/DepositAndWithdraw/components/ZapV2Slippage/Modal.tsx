...
export const Modal = observer((props: any) => {
  ...
  useEffect(() => {
    if (zapV2ChainStore.slippageTolerance) {
      setValue(zapV2ChainStore.slippageTolerance)
    }
  }, [])

  // console.log('zapV2ChainStore', zapV2ChainStore.slippageTolerance)
    ...
    >
      <div className="slippage-modal-wrapper">
        ...
        <div className="slippage-content">
          ...
          <Button
            onClick={() => {
              zapV2ChainStore.setSlippageTolerance(value > 100 ? 100 : value)
              onClose()
            }}
            type="primary"
          >
