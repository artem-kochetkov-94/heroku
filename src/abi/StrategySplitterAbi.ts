export const StrategySplitterAbi = [
  {
    anonymous: false,
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'underlyingBalance', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'strategiesBalancesSum', type: 'uint256' },
    ],
    name: 'RebalanceAll',
    type: 'event',
  },
  ...
  {
    inputs: [],
    name: 'STRATEGY_RATIO_DENOMINATOR',
