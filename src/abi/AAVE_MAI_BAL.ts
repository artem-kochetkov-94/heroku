export const AAVE_MAI_BAL_Abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'toPipeIndex', type: 'uint256' },
    ],
    name: 'getAmountOutReverted',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'pipes',
    outputs: [{ internalType: 'contract IPipe', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [],
    name: 'rebalanceAllPipes',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: 'rewardTokenIdx', type: 'uint256' }],
    name: 'rewardBalance',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    ...
    name: 'salvageFromPipeline',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: '_targetPercentage', type: 'uint256' }],
    name: 'setTargetPercentage',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
