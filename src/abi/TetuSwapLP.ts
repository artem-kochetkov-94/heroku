export const TetuSwapLPAbi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'blockTs', type: 'uint256' }],
    name: 'Claimed',
    type: 'event',
  },
  {
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'vault0', type: 'address' },
      { indexed: false, internalType: 'address', name: 'vault1', type: 'address' },
    ],
    name: 'VaultsChanged',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'reserveIn', type: 'uint256' },
      { internalType: 'uint256', name: 'reserveOut', type: 'uint256' },
      { internalType: 'uint256', name: 'amountOutWithFee', type: 'uint256' },
    ],
    name: 'getFeeAmount',
    outputs: [{ internalType: 'uint256', name: 'amountFee', type: 'uint256' }],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_vault0', type: 'address' },
