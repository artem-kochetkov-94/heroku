export const beethoven_strategy_abi = [
  {
    inputs: [
      ...
      { internalType: 'bytes32', name: '_beethovenPoolId', type: 'bytes32' },
      { internalType: 'bytes32', name: '_rewardToDepositPoolId', type: 'bytes32' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'beethovenVault',
    outputs: [{ internalType: 'contract IBeethovenVault', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
